...
urlpatterns = [
    ...
    url(r'^(?P<id>\d+)/artist_view$', views.artist_view),
    url(r'^(?P<id>\d+)/artist_update$', views.artist_update),
    url(r'^(?P<id>\d+)/editArtist$', views.editArtist),
    url(r'^(?P<id>\d+)/artist_delete$', views.artist_delete),
